#!/bin/bash
# =============================================================================
# MNIST LARGE: Comprehensive experiment
# =============================================================================
...
#
# Usage:
#   ./run_mnist_large.sh              # Run all steps (0, 1, 2)
#   ./run_mnist_large.sh 0            # Run only step 0 (experiment)
#   ./run_mnist_large.sh 1            # Run only step 1 (visualize)
#   ./run_mnist_large.sh 2            # Run only step 2 (aggregate)
#
# Device:
#   DEVICE=cuda ./run_mnist_large.sh  # Run on CUDA (recommended)
# =============================================================================
...
N_RUNS=1000
BASE_SEED=42
OUTPUT_DIR="src/scripts/exp5/exp_results/mnist_large"
DEVICE="${DEVICE:-cpu}"
DTYPE="${DTYPE:-float32}"
