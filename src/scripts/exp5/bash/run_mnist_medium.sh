...
#
# Usage:
#   ./run_mnist_medium.sh             # Run all steps (0, 1, 2)
#   ./run_mnist_medium.sh 0           # Run only step 0 (experiment)
#   ./run_mnist_medium.sh 1           # Run only step 1 (visualize)
#   ./run_mnist_medium.sh 2           # Run only step 2 (aggregate)
#   ./run_mnist_medium.sh 0 1         # Run steps 0 and 1
#
# Device:
#   DEVICE=cuda ./run_mnist_medium.sh # Run on CUDA
# =============================================================================
...
N_RUNS=20
BASE_SEED=42
OUTPUT_DIR="src/scripts/exp5/exp_results/mnist_medium"
DEVICE="${DEVICE:-cpu}"
DTYPE="${DTYPE:-float32}"
