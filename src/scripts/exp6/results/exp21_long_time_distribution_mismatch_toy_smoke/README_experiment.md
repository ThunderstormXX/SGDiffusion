# EXP21: EXP21 long-time distribution mismatch smoke

Smoke test for standard FP vs discrete FP covariance prediction.

## Reproduce

```bash
bash /Users/igoreshka/Desktop/SGDiffusion/src/scripts/exp6/scripts/run_one.sh src/scripts/exp6/results/exp21_long_time_distribution_mismatch_toy_smoke/config.yaml
```
