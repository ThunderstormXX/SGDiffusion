...
def main():
    ...
    train_script = os.path.join(base_dir, "exp18_train.py")
    
    print("🔬 ЭКСПЕРИМЕНТ 18: SGD → GD → SGD с логированием")
    ...
    for lr in learning_rates:
        ...
        train_cmd = [
            ...
            "--save-dir", "data/checkpoints/exp18"
        ]
    ...
    # Итоговый отчет
    print(f"\n{'='*80}")
    print("📊 ИТОГОВЫЙ ОТЧЕТ ЭКСПЕРИМЕНТА 18")
    print(f"{'='*80}")
    ...
    print(f"\n📁 Результаты сохранены в: data/checkpoints/exp18/")
    print("🔬 Готово для анализа поведения SGD в минимуме!")
