...
def parse_args():
    parser = argparse.ArgumentParser(description='Three-stage training: SGD → GD → SGD - Experiment 18')
    ...
    parser.add_argument('--save-dir', type=str, default='data/checkpoints/exp18', help='Save directory')
...
def main():
    ...
    plt.tight_layout()
    plot_path = os.path.join(args.save_dir, f'exp18_lr{args.lr}.png')
